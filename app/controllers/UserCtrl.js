...
// When this controler run, we want to set up an obj's..
  $scope.account = {
    email: "",
    password: ""
  };
  ...
  // Runs right away because doesnt sit inside function
  ...
  $scope.login = () => {
      ...
      .then( () => {
          ...
          // $scope.$apply();
          // window refreshed the entire page
          // window.location refreshes new page, with being logged in
  ...
  $scope.loginGoogle = () => {
    ...
    .then(function(result) {
        ...
        // does not refresh page, just changes the url in the url-bar
